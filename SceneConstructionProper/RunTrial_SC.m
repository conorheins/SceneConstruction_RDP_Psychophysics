...
if ~inf.dummy
    ...
    while eyeCheck   
        [ eyeCheck,eyeCheckDur,vbl] = doEyeCheck(Scr,myVar,inf,el,fixationCoord,quadFrameColors,quadColors,choice_pointers,eyeCheck,eyeCheckDur,vbl);
    end
end
...
vbl = fixationPeriod(Scr,myVar,fixationCoord,quadFrameColors,quadColors,fixationDur,choice_pointers,vbl);
