...
myVar.nDots    = floor(16.7/(Scr.pixelsperdegree.^2) .* prod(myVar.apSize) ./ myVar.lifetime_ms ) ;  % number of dots (density of dots in dots / squared-degree x 1/(ppd^2) x Area of aperture in pixels x 1/lifetime) 
